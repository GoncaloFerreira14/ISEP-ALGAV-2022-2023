...
cidadeArmazem(5). % Matosinhos

% Ex1 - entrega(<idEntrega>,<data>,<massaEntrega>,<armazemEntrega>,<tempoColoc>,<tempoRet>)
entrega(4439,20221206,200,1,8,10).
entrega(4438,20221206,150,9,7,9).
entrega(4445,20221206,100,3,5,7).
entrega(4443,20221206,120,11,6,8).
entrega(4449,20221206,300,8,15,20).

% Ex2 - entrega(<idEntrega>,<data>,<massaEntrega>,<armazemEntrega>,<tempoColoc>,<tempoRet>)
% entrega(4439,20221206,200,1,8,10).
% entrega(4438,20221206,150,9,7,9).
% entrega(4445,20221206,100,3,5,7).
% entrega(4443,20221206,120,11,6,8).
...
% % Ex3 - entrega(<idEntrega>,<data>,<massaEntrega>,<armazemEntrega>,<tempoColoc>,<tempoRet>)
% entrega(4512,20221207,340,16,18,21).
% entrega(4517,20221207,130,11,6,9).
% entrega(4513,20221207,270,4,14,18).
% entrega(4506,20221207,160,9,8,10).
% entrega(4526,20221207,280,14,15,19).
% entrega(4510,20221207,360,10,19,22).
% entrega(4542,20221207,300,8,15,20).
% entrega(4536,20221207,180,12,9,11).
% entrega(4532,20221207,220,6,9,12).
% entrega(4549,20221207,280,7,14,19).
% entrega(4522,20221207,380,2,20,25).
% entrega(4533,20221207,410,13,22,26).
% entrega(4538,20221207,260,15,13,18).
% entrega(4511,20221207,310,17,16,20).
% entrega(4544,20221207,100,3,5,7).
% entrega(4539,20221207,200,1,8,10).
...
%entrega varios camioes exemplo 1
...
%entrega varios camioes exemplo 2
...
%entrega varios camioes exemplo 3
